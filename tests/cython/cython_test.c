...
static const char __pyx_k_Hello_proper_Cython[] = "Hello proper Cython";
static PyObject *__pyx_kp_s_Hello_proper_Cython;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_Hello_proper_Cython, __pyx_k_Hello_proper_Cython, sizeof(__pyx_k_Hello_proper_Cython), 0, 0, 1, 0},
...
if (!__Pyx_RefNanny) {
  ...
  /* "cython_test.pyx":1
 * print("Hello proper Cython")             # <<<<<<<<<<<<<<
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_Hello_proper_Cython) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
